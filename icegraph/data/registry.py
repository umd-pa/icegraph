...
class DatasetRegistry:
    ...
    def __init__(
        ...
        Args:
            ...
            map_file (Optional[Union[str, Path]]): Path to the split mapping file generated by `DatasetSplitter`. Does nothing except save the source to the registry for later access.
        """
